...
# sub_lists = os.listdir(scene_path)
    ...
    cmd = f'CUDA_VISIBLE_DEVICES={gpu_id} python train.py -s {data_base_path}/{scene} -m {out_base_path}/{scene}/{out_name} -i {destination_dir} --max_abs_split_points 0 --opacity_cull_threshold 0.05'
