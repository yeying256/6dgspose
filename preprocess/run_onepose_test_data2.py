...
data_base_path='/media/wangxiao/Newsmy/dataset_LINEMOD/datasets/test_data_sfm'
out_base_path='/media/wangxiao/Newsmy/dataset_LINEMOD/datasets/test_data_pgsr2'
