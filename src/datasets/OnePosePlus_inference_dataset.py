...
class OnePosePlusInferenceDataset(Dataset):
    def __init__(
        ...
        print(f'Will process:{len(self.image_paths)} images ')
        ...
        # 加载点云和点的特征 sfmws/anno/anno_3d_average.npz
    ...
    def get_default_paths(self, sfm_model_dir):
        ...
        # avg_anno_3d_path = osp.join(anno_dir, "anno_3dgs.npz")
    ...
    def read_anno3d(
        ...
        if load_3d_coarse:
            avg_anno3d_coarse_file = (
                # osp.join(osp.dirname(avg_anno3d_file),"anno_3d_average_coarse.npz")
